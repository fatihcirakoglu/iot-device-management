...
class Device(models.Model):
    ...
    serialno = models.IntegerField(default=0, editable=True, unique=True)
    status = models.IntegerField(default=0, editable=False)
    deviceinfo = models.CharField(max_length=2000, editable=True)
    deviceuptime = models.CharField(max_length=2000, editable=True)
    deviceusers = models.CharField(max_length=2000, editable=True)
    devicesnaps = models.CharField(max_length=2000, editable=True)
