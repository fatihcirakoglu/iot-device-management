...
class Device(models.Model):
    ...
    brand = models.CharField(max_length=200, unique=True, editable=False)
    model = models.CharField(max_length=200, unique=True, editable=False)
    serialno = models.IntegerField(default=0, editable=False)
